...
#define L1_SPC LT(_NUMBER_LAYER, KC_SPACE)
#define L2_SPC LT(_FUNCTION_LAYER, KC_SPACE)
#define L3_F LT(_MODIFIER_1_LAYER, KC_F)
#define L4_J LT(_MODIFIER_2_LAYER, KC_J)
#define L5_MOD MO(_MEDIA_LAYER)
